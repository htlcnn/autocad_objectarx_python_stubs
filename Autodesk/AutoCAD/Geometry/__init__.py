...
class ClipBoundary2dData(public struct ClipBoundary2dData {
}):
    """
...
class CompositeParameter(public struct CompositeParameter {
}):
    """
...
class CoordinateSystem2d(IFormattable {
}):
    """
...
class CoordinateSystem3d(IFormattable {
}):
    """
...
class Curve2dCollection(DisposableWrapper, IList):
    """
...
class Curve3dCollection(DisposableWrapper, IList):
    """
...
class CurveBoundary(DisposableWrapper, ICloneable):
    """
...
class CurveBoundaryData(public struct CurveBoundaryData {
}):
    """
...
class Entity2d(DisposableWrapper, ICloneable):
    """
...
class Entity3d(DisposableWrapper, ICloneable):
    """
...
class KnotCollection(DisposableWrapper, IList):
    """
...
class Matrix2dBuilder(public class Matrix2dBuilder):
    """
...
class Matrix2dInfo(public struct Matrix2dInfo {
}):
    """
...
class Matrix3dBuilder(public class Matrix3dBuilder):
    """
...
class NurbCurve2dData(public struct NurbCurve2dData {
}):
    """
...
class NurbCurve2dFitData(Public Structure NurbCurve2dFitData
End Structure):
    """
...
class NurbCurve3dData(public struct NurbCurve3dData {
}):
    """
...
class NurbCurve3dFitData(public struct NurbCurve3dFitData {
}):
    """
...
class NurbSurfaceDefinition(public struct NurbSurfaceDefinition {
}):
    """
...
class PlanarEntity(S(u,v) = originOfPlanarEntity + u * uAxis + v * vAxis):
    """
...
class PlanarEquationCoefficients(public struct PlanarEquationCoefficients {
}):
    """
...
class Point3dCollection(DisposableWrapper, IList):
    """
...
class Scale2d(public struct Scale2d {
}):
    """
...
class Scale3d(public struct Scale3d {
}):
    """
