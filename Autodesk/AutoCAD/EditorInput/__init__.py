class AcMgdLivePreviewAction(internal struct AcMgdLivePreviewAction {
...
class AcMgdLivePreviewContextReactor(internal struct AcMgdLivePreviewContextReactor {
  private long <alignment member>;
}):
    """
...
class AcMgdLivePreviewReactor(internal struct AcMgdLivePreviewReactor {
  private long <alignment member>;
}):
    """
...
class CursorBadgeUtilities(public class CursorBadgeUtilities):
    """
...
class Editor(MarshalByRefObject):
    ...
    class CommandResult(INotifyCompletion):
        """
...
class EditorExtension(public static class EditorExtension):
    """
...
class EditorUserInteraction(IDisposable):
    """
...
class EditorVisualStyle(public sealed class EditorVisualStyle):
    """
...
class InputPointContext(IDisposable):
    """
...
class Jig(public abstract class Jig):
    """
...
class JigPrompts(public sealed class JigPrompts):
    """
...
class Keyword(public sealed class Keyword):
    """
...
class KeywordCollection(ICollection, IEnumerable):
    """
...
class LivePreviewActionBase(public abstract class LivePreviewActionBase):
    """
...
class LivePreviewContextParameter(public sealed class LivePreviewContextParameter):
    """
...
class LivePreviewContextProxy(IDisposable):
    """
...
class PointFilterEventArgs(EventArgs, IDisposable):
    """
...
class PointFilterResult(IDisposable):
    """
...
class PromptFileOptions(public abstract class PromptFileOptions):
    """
...
class PromptForEntityEndingEventArgs(EventArgs, IDisposable):
    """
...
class PromptForSelectionEndingEventArgs(EventArgs, IDisposable):
    """
...
class PromptOptions(public abstract class PromptOptions):
    """
...
class PromptResult(public class PromptResult):
    """
...
class PromptSelectionOptions(public sealed class PromptSelectionOptions):
    """
...
class PromptSelectionResult(public sealed class PromptSelectionResult):
    """
...
class SelectedSubObject(public class SelectedSubObject):
    """
...
class SelectionAddedEventArgs(EventArgs, IDisposable):
    """
...
class SelectionDetails(public class SelectionDetails):
    """
...
class SelectionFilter(public sealed class SelectionFilter):
    """
...
class SelectionSet(ICollection, IDisposable):
    """
