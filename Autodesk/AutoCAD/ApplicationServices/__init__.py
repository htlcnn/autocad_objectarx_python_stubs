...
class BeginCloseAllEventArgs(object):
    """
...
class BeginQuitEventArgs(object):
    """
...
class ConfigurationSectionNameAttribute(object):
    """
    
    ConfigurationSectionNameAttribute
        string name : Input a System.String object which represents the name of the Configuration Section.
    """
    Name = None
...
class DocWindowManagerReactor(object):
    """
...
class DocumentActivationChangedEventArgs(object):
    """
...
class DocumentBeginCloseEventArgs(object):
    """
...
class DocumentClosedEventArgs(object):
    """
...
class DocumentCollectionEventArgs(object):
    """
...
class DocumentDestroyedEventArgs(object):
    """
...
class DocumentLockModeChangeVetoedEventArgs(object):
    """
...
class DocumentLockModeChangedEventArgs(object):
    """
...
class DocumentLockModeWillChangeEventArgs(object):
    """
...
class DocumentPinStateChangedEventArgs(object):
    """
...
class DocumentWindowActivatedEventArgs(object):
    """
...
class IConfigurationSection(object):
    """
...
class InplaceTextEditorSettings(object):
    """
...
class LayoutSwitchedEventArgs(object):
    """
...
class LayoutSwitchingEventArgs(object):
    """
...
class LispWillStartEventArgs(object):
    """
...
class LongTransactionManager(object):
    """
...
class RecentDocumentCollection(object):
    """
...
class SystemVariableChangedEventArgs(object):
    """
...
class SystemVariableChangingEventArgs(object):
    """
...
class TabbedDialogEventArgs(object):
    """
...
class TabbedDialogExtension(object):
    ...
    TabbedDialogExtension(System.Windows.Forms.Control, TabbedDialogAction)
        System.Windows.Forms.Control control : Input which owns this extension.
        TabbedDialogAction onOK : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on an "Ok" click.
    
    
    TabbedDialogExtension(System.Windows.Forms.Control, TabbedDialogAction, TabbedDialogAction)
        System.Windows.Forms.Control control : Input which owns this extension.
        TabbedDialogAction onOK : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on an "Ok" click.
        TabbedDialogAction onCancel : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on a "Cancel" click.
    
    
    TabbedDialogExtension(System.Windows.Forms.Control, TabbedDialogAction, TabbedDialogAction, TabbedDialogAction)
        System.Windows.Forms.Control control : Input which owns this extension.
        TabbedDialogAction onOK : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on an "Ok" click.
        TabbedDialogAction onCancel : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on a "Cancel" click.
        TabbedDialogAction onHelp : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on a "Help" click.
    
    
    TabbedDialogExtension(System.Windows.Forms.Control, TabbedDialogAction, TabbedDialogAction, TabbedDialogAction, TabbedDialogAction)
        System.Windows.Forms.Control control : Input which owns this extension.
        TabbedDialogAction onOK : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on an "Ok" click.
        TabbedDialogAction onCancel : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on a "Cancel" click.
        TabbedDialogAction onHelp : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on a "Help" click.
        TabbedDialogAction onApply : Input Autodesk.AutoCAD.ApplicationServices.TabbedDialogAction object to handle what happens on an "Apply" click.
...
class UnknownCommandEventArgs(object):
    """
...
class UserConfigurationManager(object):
    """
